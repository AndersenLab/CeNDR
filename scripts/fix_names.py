...
with open("../ancillary/gs_file_locs.tsv", 'r') as f:
    for line in f.readlines():
        ...
        if line.endswith("LDplot-1.png"):
            ...
            print "gsutil cp -n %s %s" % (line, to)
        elif line.endswith("PxGplot-1.png"):
        ...
        elif line.find("unnamed-chunk") > 0:
            print "gsutil rm %s" % (line)    
...
#
# LATER, GO BACK AND REMOVE -1.png files, and raw_phenotype.tsv
# REMOVE   interval_variants.tsv also